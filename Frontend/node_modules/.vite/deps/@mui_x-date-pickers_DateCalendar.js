...
} from "./chunk-HZQKIWAC.js";
import {
  useSlotProps_default
} from "./chunk-NCJXC3RM.js";
import {
  MuiPickersAdapterContext
} from "./chunk-PPOFENSU.js";
import {
  IconButton_default
} from "./chunk-BKG5BUYE.js";
import "./chunk-7PGUH64J.js";
import "./chunk-2UANQG6Q.js";
import "./chunk-QSNV7DNS.js";
import "./chunk-IL63KW7A.js";
import "./chunk-W3YRXOR7.js";
import "./chunk-IVBT57EC.js";
import {
  Typography_default
} from "./chunk-OQSXQHN2.js";
import "./chunk-ZLI2EZDW.js";
import "./chunk-D4JPVYFV.js";
import {
  ButtonBase_default
} from "./chunk-MCB53VMY.js";
import "./chunk-Z7PYWZAI.js";
import "./chunk-ULYIAVQG.js";
import {
  CSSTransition_default,
  Timeout,
  TransitionGroup_default
} from "./chunk-YEBKQOWB.js";
import {
...
import {
  useThemeProps
} from "./chunk-B2WP7TAO.js";
import "./chunk-RU5XAGBT.js";
import "./chunk-ITGWAFDM.js";
import "./chunk-JBOM32NB.js";
import {
  useControlled
} from "./chunk-CIOCPT4B.js";
import "./chunk-M66LTLN6.js";
import "./chunk-SUSNWJV4.js";
import "./chunk-3EMBM3HE.js";
import "./chunk-GOZHMSIK.js";
import {
  createSvgIcon
} from "./chunk-V75U6NVZ.js";
import "./chunk-KM2JHBTZ.js";
import {
  useEventCallback_default
} from "./chunk-GH43PLAD.js";
import "./chunk-ZOQU5MKA.js";
import "./chunk-CJROFMQY.js";
import {
  useForkRef
} from "./chunk-UUIOHDPQ.js";
import "./chunk-DCPVWY2X.js";
import "./chunk-2DUBT2S6.js";
import "./chunk-3FX6MB4A.js";
import {
  useTheme
} from "./chunk-2TBD45Y5.js";
import {
  alpha,
  clsx_default,
  composeClasses,
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React6.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
var PickerContext = React10.createContext(null);
...
function usePickerDayOwnerState(parameters) {
  ...
  return React13.useMemo(() => _extends({}, pickerOwnerState, {
    day,
...
var PickersDayRaw = React14.forwardRef(function PickersDay(inProps, forwardedRef) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersDay"
  });
...
var PickersDay2 = React14.memo(PickersDayRaw);
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React16.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
var MonthCalendarButton = React17.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime6.jsx)(MonthButton, _extends({}, monthButtonProps));
});
...
var MonthCalendar = React20.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React20.useMemo(() => utils.getMonth(now), [utils, now]);
  const selectedMonth = React20.useMemo(() => {
    if (value != null) {
      return utils.getMonth(value);
    }
    return null;
  }, [value, utils]);
  const [focusedMonth, setFocusedMonth] = React20.useState(() => selectedMonth || utils.getMonth(referenceDate));
  ...
  const isMonthDisabled = React20.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime7.jsx)(MonthCalendarRoot, _extends({
    ...
    children: getMonthsInYear(utils, value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime7.jsx)(MonthCalendarButton, {
        selected: isSelected,
        value: monthNumber,
...
var YearCalendarButton = React21.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime8.jsx)(YearButton, _extends({}, yearButtonProps));
});
...
var YearCalendar = React22.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React22.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React22.useMemo(() => {
    if (value != null) {
      return utils.getYear(value);
    }
    return null;
  }, [value, utils]);
  const [focusedYear, setFocusedYear] = React22.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React22.useCallback((dateToValidate) => {
  ...
  const scrollerRef = React22.useRef(null);
  ...
  return (0, import_jsx_runtime9.jsxs)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: [yearRange.map((year) => {
      ...
      return (0, import_jsx_runtime9.jsx)(YearCalendarButton, {
        selected: isSelected,
        value: yearNumber,
      ...
      length: fillerAmount
    }, (_, index) => (0, import_jsx_runtime9.jsx)(YearCalendarButtonFiller, {}, index))]
  }));
});
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React24.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React24.Fragment, {
  children: [(0, import_jsx_runtime10.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime10.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var _excluded10 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId", "classes"];
...
var _excluded11 = ["slots", "slotProps", "currentMonth", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onMonthChange", "onViewChange", "view", "reduceAnimations", "views", "labelId", "className", "classes", "timezone", "format"];
...
var PickersCalendarHeader = React27.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickerTranslations();
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
  ...
  return (0, import_jsx_runtime12.jsxs)(PickersCalendarHeaderRoot, _extends({}, other, {
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
    children: [(0, import_jsx_runtime12.jsxs)(PickersCalendarHeaderLabelContainer, {
      role: "presentation",
      ...
      }), views.length > 1 && !disabled && (0, import_jsx_runtime12.jsx)(SwitchViewButton, _extends({}, switchViewButtonProps, {
        children: (0, import_jsx_runtime12.jsx)(SwitchViewIcon, _extends({}, switchViewIconProps))
      }))]
...
function useDateCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, validationProps, {
    ...
    reduceAnimations,
    renderLoading: themeProps.renderLoading ?? (() => (0, import_jsx_runtime13.jsx)("span", {
      children: "..."
    }))
  });
}
...
var DateCalendar = React28.forwardRef(function DateCalendar2(inProps, ref) {
  const utils = useUtils();
  const {
    ownerState
  } = usePickerPrivateContext();
  ...
  const prevOpenViewRef = React28.useRef(view);
  React28.useEffect(() => {
  ...
  const selectedDays = React28.useMemo(() => [value], [value]);
  return (0, import_jsx_runtime13.jsxs)(DateCalendarRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime13.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
      slots,
      slotProps
    })), (0, import_jsx_runtime13.jsx)(DateCalendarViewTransitionContainer, {
      reduceAnimations,
      className: classes.viewTransitionContainer,
      transKey: view,
      ownerState,
      children: (0, import_jsx_runtime13.jsxs)("div", {
        children: [view === "year" && (0, import_jsx_runtime13.jsx)(YearCalendar, _extends({}, baseDateValidationProps, commonViewProps, {
          value,
          ...
          yearsPerRow,
          referenceDate
        })), view === "month" && (0, import_jsx_runtime13.jsx)(MonthCalendar, _extends({}, baseDateValidationProps, commonViewProps, {
          hasFocus,
          className,
          value,
          ...
          monthsPerRow,
          referenceDate
        })), view === "day" && (0, import_jsx_runtime13.jsx)(DayCalendar, _extends({}, calendarState, baseDateValidationProps, commonViewProps, {
          onMonthSwitchingAnimationEnd,
          hasFocus,
