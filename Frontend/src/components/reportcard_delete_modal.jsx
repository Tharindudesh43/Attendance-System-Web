...
const ReportCardDeleteModal = ({ reportId, reportimages,userId,onClose}) => {
    ...
    async function reportcarddelete (event) {
        setIsDeleting(true);
        ...
        reportimages.forEach((item) => {
          ...
          if(data.status==='ok'){
              ...
              if(reply.status==='ok'){
                setIsDeleting(false);
                enqueueSnackbar("Report Delete Successfully!", { 
                  variant: "success", 
              ...
              enqueueSnackbar("Error Deleting Report from Firebase", {
                  variant: "error",
                  autoHideDuration: 3000
              });
            }
            ...
            enqueueSnackbar("Error Deleting Report", {
                variant: "error",
                autoHideDuration: 3000
            });
            setIsDeleting(false);
...
export default ReportCardDeleteModal;
