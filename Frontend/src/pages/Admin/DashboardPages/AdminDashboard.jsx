...
const Overview = ({ stats }) => {
  const recentActivity = [
    { title: "Dr.",  name: "Alex Jones",               department: "ICT", faculty: "Faculty of Technology", contactno: "949348095890", subjects: ["SWT 40016","SWT 42016","SWT 41032"] },
    { title: "Mr.", name: "Tharindu Deshan Himahansa", department: "ICT", faculty: "Faculty of Technology", contactno: "710182874",    subjects: ["SWT 32022"] },
  ];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div className="stats-grid" style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        <StatCard label="Total Lecturers" value={stats.totalLecturers ?? "2"}      sub="+2 this month"    accent="#2563eb" icon={Icons.user} />
        <StatCard label="Total Sessions"  value={stats.totalSessions  ?? "5"}      sub="This semester"    accent="#22c55e" icon={Icons.calendar} />
        <StatCard label="Attendance Rate" value={`${stats.overallRate ?? "77"}%`}  sub="Overall present"  accent="#f59e0b" icon={Icons.chart} />
