    ...
    <div className="bg-gradient-to-b from-[#f0f4f8] to-[#d9e2ec] min-h-screen flex flex-col font-['Inter']">
      ...
      <section className="flex flex-col-reverse items-center justify-between gap-12 px-6 py-20 mx-auto md:flex-row max-w-7xl">
        ...
        >
          ...
          >
            Streamline attendance management for admins and lecturers with ease
            and efficiency.
          </p>
      ...
      <section
        id="login"
        className="grid max-w-5xl grid-cols-1 gap-12 p-12 mx-auto mb-20 bg-white shadow-xl rounded-xl md:grid-cols-2"
      >
        {[
          {
            title: "Admin Portal",
            description:
              "Access the admin dashboard to manage users, attendance records, and system settings.",
            color: "bg-[#dc2626]",
          ...
          },
          {
            ...
            description:
              "Log in to mark attendance, view your classes, and manage student records.",
            color: "bg-[#22c55e]",
          ...
          <div
            key={i}
            className="flex flex-col justify-between p-8 transition border rounded-lg shadow-md cursor-pointer hover:shadow-lg"
          >
            <div>
              <h2
                style={{ fontFamily: "Poppins" }}
      ...
      <section
        id="aboutus"
        className="grid items-center gap-10 px-6 py-20 mx-auto text-center max-w-7xl md:text-left md:grid-cols-2"
      >
        <img
        ...
        <div>
          ...
          >
            The Marky Attendance System is a smart digital platform designed to
            simplify and secure attendance tracking for university students and
            staff.
          </p>
          <p
            style={{ fontFamily: "Poppins" }}
          ...
          >
            It enhances academic management by offering real-time attendance
            monitoring, easy login portals, and detailed reports for admins and
            lecturers.
          </p>
        </div>
      </section>
      ...
      <section
        id="contact"
        className="max-w-4xl p-12 mx-auto mb-20 bg-white shadow-xl rounded-xl"
      >
        <h3
          style={{ fontFamily: "Poppins" }}
          className="text-3xl font-extrabold text-center text-[#1e293b] mb-8"
        >
          Contact Us
        </h3>
        <form className="max-w-xl mx-auto space-y-6">
          ...
          <button
            style={{ fontFamily: "Poppins" }}
            type="submit"
            className="bg-[#2563eb] text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-[#1e40af] transition w-full"
          >
            Send Message
          </button>
        </form>
