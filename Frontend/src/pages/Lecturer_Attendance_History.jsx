        ...
        <div class="overflow-x-auto w-full">
          <table class="min-w-full bg-white">
            ...
            {loadingimg2 ? (
              <td
                colSpan="6"
                class="p-10 items-center justify-center font-medium text-center"
              >
              ...
              <tbody class="whitespace-nowrap">
                <tr class="hover:bg-gray-50">
                  <td
                    colspan="5"
                    class="p-4 text-[15px] text-black font-medium text-center"
                  >
                    No Data Added Yet.
                  </td>
                </tr>
                        ...
                        <div class="flex items-center">
                          <button
                            onClick={(event) => {
                              ...
                              navigate(
                                `/lecturer/att_history_data/${id}/${encodeURIComponent(subjectDetails[3])}/${encodeURIComponent(subjectDetails[1])}`,
                              );
                            }}
