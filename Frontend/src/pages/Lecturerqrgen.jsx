    ...
    <div className="flex flex-col min-h-screen ">
                    ...
                    <tbody className="whitespace-nowrap">
                      {allsubjects.map((subjectSet, index) =>
                        subjectSet.map((subjectDetails, subIndex) => (
                          ...
                          >
                            <td
                              className={`p-4 text-[13px]  ${selectedindex === index ? "text-white" : "text-slate-900"} font-medium whitespace-normal break-words max-w-[180px]`}
                            >
                              {subjectDetails[3]}
                            </td>
                            <td
          ...
          <div className="flex flex-col gap-6 md:col-span-2">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-row items-center justify-center gap-3">
                              ...
                              <MenuList id="split-button-menu" autoFocusItem>
                                {durationOptions.map((option, index) => (
                                  <MenuItem
                                    key={option}
                                    onClick={(event) =>
                                      handleSelectDuration(event, index)
                                    }
                                  >
                                    {option}
                                  </MenuItem>
                ...
                {/* Reset Button */}
                <div className="">
                  <Button color="error" onClick={resetall} variant="contained">
                    Reset
                  </Button>
                </div>
              </div>
                ...
                {QRtext && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
                    <div className="flex flex-col items-center p-8 bg-white shadow-lg rounded-2xl">
                      ...
                      <p className="p-2 font-semibold text-center text-blue-600">
                        ...
                        <tbody className="whitespace-nowrap">
                          {Array.isArray(allattendace) &&
                            allattendace.map((student, index) => (
                              <tr
                                key={index}
                                className="text-left bg-white cursor-pointer hover:bg-black"
                              >
      ...
      {SubjectTitleDescriptionShowModal && (
        <SubjectTitleDescription
          onClose={() => setSubjectTitleDescriptionShowModal(false)}
        />
      )}
