...
const AdminSubject = () => {
  ...
  const [selectedSemesterVersion, setselectedSemesterVersion] = useState(
    "Select a Semester Version",
  );
  ...
  const handleacademicyearclose = (event) => {
    if (
      ...
      AcademicYearDropdownRef.current.contains(event.target)
    ) {
      return;
    }
  ...
  const handlesemesterversionclose = (event) => {
    if (
      SemesterversionDropdownRef.current &&
      SemesterversionDropdownRef.current.contains(event.target)
    ) {
      return;
    }
  ...
  async function addlec_subject(event) {
    ...
    if (selectedSubject === "Select a Subject") {
      ...
      try {
        ...
        const response_dup = await axios.post(
          `${import.meta.env.VITE_API_BASE_URL}/admin/finddup`,
          subjectData,
          {
        ...
        if (response_dup.data.status === "not") {
          ...
          const response = await axios.post(
            `${import.meta.env.VITE_API_BASE_URL}/admin/addsubjects`,
            subjectData,
            {
              headers: { "Content-Type": "multipart/form-data" },
            },
              ...
              <React.Fragment>
                ...
                >
                  ...
                  <Button
                    size="small"
                    aria-controls={
                      isOpenSemVersion ? "split-button-menu" : undefined
                    }
                ...
                >
                  {({ TransitionProps }) => (
                    ...
                    >
                      <Paper>
                        <ClickAwayListener
                          onClickAway={handlesemesterversionclose}
                        >
                          <MenuList
              ...
              <React.Fragment>
                ...
                >
                  ...
                  <Button
                    size="small"
                    aria-controls={
                      isOpenAc_Year ? "split-button-menu" : undefined
                    }
                ...
                >
                  {({ TransitionProps, placement }) => (
                    ...
                    >
                      <Paper>
                        <ClickAwayListener
                          onClickAway={handleacademicyearclose}
                        >
              ...
              <React.Fragment>
                ...
                >
                  ...
                  <Button
                    size="small"
                    aria-controls={
                      isOpenSemester ? "split-button-menu" : undefined
                    }
              ...
              <React.Fragment>
                ...
                >
                  ...
                  <Button
                    size="small"
                    aria-controls={
                      isOpenSubject ? "split-button-menu" : undefined
                    }
            ...
            <div className="flex grid items-center w-full grid-rows-1 p-4 rounded-lg shadow-sm gap-y-2 gap-x-2">
              {findingDuplicateSubjects ? (
                <div className="flex items-center justify-center col-span-full">
                  <img
                    src="../src/assets/search.gif"
                    alt="Loading..."
                    className="w-20 h-20"
                  />
                  <img
                    src="../src/assets/findingdup_text.svg"
            ...
            <div className="flex items-center p-4 border rounded-lg shadow-sm">
              ...
              <div className="flex ml-auto space-x-4">
                ...
                <button
                  ...
                  className="px-4 py-2 font-semibold text-red-700 bg-transparent border border-red-500 rounded cursor-pointer hover:bg-red-500 hover:text-white hover:border-transparent"
                >
                  Reset
                </button>
              </div>
