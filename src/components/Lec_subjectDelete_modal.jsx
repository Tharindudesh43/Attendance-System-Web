...
const LecSubjectDeleteModal = ({
  ...
  async function deletesubject(event) {
    ...
    try {
      const response = await axios.delete(
        `${import.meta.env.VITE_API_BASE_URL}/admin/deleteSubject`,
        {
  ...
  return (
    <div>
      <div id="modal">
        <div class="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-100 z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto">
          <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
            ...
            <div class="my-6 text-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-16 h-16 fill-red-500 inline"
                viewBox="0 0 24 24"
              >
                <path
              ...
              <h4 class="text-slate-900  text-base font-medium mt-4">
                Are you sure you want to delete? BECAUSE ALL ATTENDANCE DATA
                WILL NOT BE RECOVERABALE
                <h6 className="font-bold text-red-700 text-md">{subject}</h6>
              </h4>
              ...
              <div class="text-center space-x-4 mt-10">
                <button
                  ...
                  type="button"
                  onClick={onClose}
                  class="px-5 py-2.5 cursor-pointer rounded-lg text-slate-900 text-sm font-medium bg-gray-200 hover:bg-gray-300 active:bg-gray-200"
                >
                  No, Cancel
                </button>
