      ...
      <div className="flex flex-col w-full h-screen md:flex-row">
        <div className="flex items-center justify-center flex-grow bg-gray-200">
          <div className="w-1/2 p-10 bg-white rounded-lg shadow-lg sm-h-1/2 md-h-1/2 lg-h-1/2">
            ...
            <p className="pb-3 mt-2 text-gray-600">
              This window only for a admin.
            </p>
            <AdminButton
              className="font-medium tracking-wider bg-red-700 border border-current outline-none cursor-pointer hover:bg-green-500 active:bg-blue-700"
        ...
        <div className="flex items-center justify-center flex-grow bg-gray-200">
          <div className="w-1/2 p-10 bg-white rounded-lg shadow-lg sm-h-1/2 md-h-1/2 lg-h-1/2">
            ...
            <p className="pb-3 mt-2 text-gray-600">
              This window for lecturers.
            </p>
            <LecturerButton
              className="font-medium tracking-wider border border-current outline-none cursor-pointer"
